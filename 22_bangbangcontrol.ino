...
// Servo adjustment
#define _DUTY_MAX 1660  // Servo angle: D degree
#define _DUTY_NEU 1029  // Servo angle: 0 degree
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return 250+642.0 - 2.23*(a_value) + (1.95/1000.0)*(a_value*a_value);
}
